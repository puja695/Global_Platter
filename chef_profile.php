...
session_start();
PROTECT CHEF PAGE
if (lisset($_ SESSION['chef_id'])) (
header ("Location: login.php");
exit;
$chef_name = $_SESSION['chef name'] ?? "chef";
RANDOM BOOKINGS
/*
*/
Srandom bookings
...
1
shuffle($sample reviews);
Srandom reviews = array slice($sample reviews, 0, 3);
$avg rating = array_sum(array_ column($random_reviews, 'rating')) / count($random_ reviews);
*
---RANDOM STATS
$total _bookings = rand(15, 60);
Sexperience years = rand(1, 10);
/
Savatar = "assets/images/chef_avatar.png";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
• logoffont-size:22px;font-weight:bold;)
.nav-links(display:flex;gap:20px;list-style:none;>
.nav-links afcolor:#fff;text-decoration:none;font-weight:600;)
...
‣hero h1{
font-size;34px;
background:linear-gradient (o0deg,#ffd700,#ffda75,lffd700);
...
.
logoutf
display:inline-block;margin:6opx auto 0;
...
cul class-"nav-links">
<li><a href-"chef_profile.php" class-"active">My Profile</ax</li>
<ful>
</nav>
</header>
...
<div>
<h1>Welcome Chef <?php echo htmlspecialchars (schef_name); ?> 8</h1>
<p><?php echo $experience_ years; ?>+ years of culinary excellence</p>
</div>
</div>
<I-- STATS
...
<div class="value"><?php echo $total bookings; ?x</div>
</div>
<div class="card">
<div class="label" >Average Rating</div>
<div class=" "value"><?php echo number format ($avg rating, 1); ?> *</div>
</div>
</div>
<I-- RECENT BOOKINGS
<div class="section grid">
...
<?php foreach(frandom reviews as $r): ?>
<div class="list-item">
